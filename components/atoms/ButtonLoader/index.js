const ButtonLoader = () => {
  return (
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" style={{margin: "auto", background: "none", display: "block", shapeRendering: "auto"}} width="18px" height="18px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
<rect x="17" y="5" width="16" height="90" fill="#ffffff">
...
<rect x="42" y="5" width="16" height="90" fill="#ffffff">
...
<rect x="67" y="5" width="16" height="90" fill="#ffffff">
